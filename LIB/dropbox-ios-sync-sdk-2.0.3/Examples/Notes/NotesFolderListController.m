...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [_filesystem addObserver:self forPathAndChildren:self.root block:^()
    {
        NSLog(@"willappear");
        [weakSelf loadFiles];
    }];
...
- (void)reload
{
    ...
    UIBarButtonItem *moveItem = [[UIBarButtonItem alloc]
    ...
    else
    {
        ...
        if (_filesystem.status & DBSyncStatusUploading)
        {
            ...
            UIBarButtonItem *uploadItem = [[UIBarButtonItem alloc] initWithCustomView:activityIndicator];
